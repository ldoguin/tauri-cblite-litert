...
export declare function createFtsIndex(collection: string, indexName: string, field: string, language?: string): Promise<void>;
...
/**
 * Write a text file to user-accessible storage and return the saved path.
 * On Android: /sdcard/Android/data/<pkg>/files/<filename>  (ADB-accessible)
 * On desktop: ~/Downloads/<filename>
 */
